...
import confirmPresentialCome from "./confirmPresential.come.js";

export default addKeyword<Provider, Database>(
  utils.setEvent("SAVETURN_PRESENTIAL_COME")
).addAction(
  { capture: true },
          ...
          return endFlow(
            `Tu turno Fue guardado con exito!. ${
              turnoNew.hasOwnProperty("me")
                ...
                : `Ahora te toca esperar la confirmacion del turno de parte del profesional, el precio del turno es ${turnoNew.price}\n\nSi quieres volver al menu en cualquier momento escribe. *miturno ${medicData.consultName}*`
            }`
          );
        });
